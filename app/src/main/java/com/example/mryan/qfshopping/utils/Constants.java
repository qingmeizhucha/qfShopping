package com.example.mryan.qfshopping.utils;

public class Constants {
    public static final String BASE = "http://172.30.131.87:8080";
    // 请求 Json 数据基本 URL
    ...
    public static final String BAG_URL = Base_URL_JSON + "BAG_URL.json";//装扮
    ...
    public static final String GAME_URL=Base_URL_JSON+"GAME_URL.json";//页面的具体数据的 id
